...
public class TransHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ProfileTransactionListAdapter(this,orderModelList, payTransactionTouchListener);
        ...
        call.enqueue(new Callback<List<DocumentModel>>() {
            ...
            public void onResponse(Call<List<DocumentModel>> call, Response<List<DocumentModel>> response) {
                ...
                if (code == 200) {
                    ...
                    adapter = new ProfileTransactionListAdapter(TransHistoryActivity.this,orderModelList, payTransactionTouchListener);
